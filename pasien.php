    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a href="#" class="navbar-brand">Eydith App</a>
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalhapus">Hapus</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Anda yakin ingin menghapus pasien atas nama : <?php echo $row['idPasien']?>
                                        </div>
